...
### 2024.01.03 UPDATE: From now on, the latest version of TRAPS will be maintained in the [LO repo](https://github.com/parkermac/LO/tree/main/traps_notes). This LO_traps repo is now obsolete.
